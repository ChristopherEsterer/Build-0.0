    ...
    if mac1 == format("".join(['%02x'%b for b in notifParams.macAddress])):
        try:  
            ...
            # Splitting the string into 10 blocks of 4 Hex values
             ...
             for i in range(0,10):
                if i == 0:
                    text_file1.write( first_timems + "," + queue.popleft() + "\n") 
                elif i == 1: 
                    text_file1.write( second_timems + "," + queue.popleft() + "\n")
                elif i == 2: 
                    text_file1.write( third_timems + "," + queue.popleft() + "\n")
                elif i == 3: 
                    text_file1.write( fourth_timems + "," + queue.popleft() + "\n")
                elif i == 4:
                    text_file1.write( fifth_timems + "," + queue.popleft() + "\n")
                elif i == 5:
                    text_file1.write( sixth_timems + "," + queue.popleft() + "\n")
                elif i == 6: 
                    text_file1.write( seventh_timems + "," + queue.popleft() + "\n")
                elif i == 7:
                    text_file1.write( eigth_timems + "," + queue.popleft() + "\n")
                elif i == 8: 
                    text_file1.write( ninth_timems + "," + queue.popleft() + "\n")
                elif i == 9: 
                    text_file1.write( tenth_timems + "," + queue.popleft() + "\n")
                else:
                    print ("Done")
